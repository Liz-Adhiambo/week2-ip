...
function validDay(){
  ...
  var dayNumber = parseInt(document.getElementById("birthDay").value);
  var yearNumber = parseInt(document.getElementById("birthYear").value);
  var yearNumber = parseInt(document.getElementById("birthCentury").value);
